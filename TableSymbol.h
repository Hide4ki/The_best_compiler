...
enum class Delim { COMMA = 1, DQUOTES, SQUOTES, SEMICOLON, OR_OP, AND_OP, EQ_OP, NOTEQ_OP, ASS_OP, LARGE_OP, LESS_OP, INC_OP, ADD_OP, DIV_OP, MUL_OP, NOT_OP, NEG_OP, RBRACKETS_L, RBRACKETS_R, BRACKETS_L, BRACKETS_R, GOTO, IFGOTO, WRITE, READ};

const int numberDelim = static_cast<int>(Delim::BRACKETS_R) + 1;

enum class ServWord { PROGRAMM = 1, TRUE, READ, WRITE, FALSE, END, INTEGER, BOOL, STRING, FOR, WHILE, IF, ELSE, DO, ENDWHILE, ENDIF, ENDFOR };
